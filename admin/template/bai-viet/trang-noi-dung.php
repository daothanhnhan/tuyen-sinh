<?php
    if (isset($_GET['search']) && $_GET['search'] != '') {
	   ...
	   $rows = $action->getList('page','khoa_id',$_GET['khoa_id'],'page_id','desc',$trang,20,'bai-viet');
    }
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php 
                    ...
                    ?>
                        <tr>
                            <td><a href="index.php?page=sua-bai-viet&id=<?= $row['page_id'];?>&khoa_id=<?= $_GET['khoa_id'] ?>" title="<?= $row['page_name'];?>"><?= $row['page_name'];?></a></td>
                            <td>
