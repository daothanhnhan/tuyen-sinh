<?php 
    ...
    function noi_ve_khoa ($id) {
        ...
        if (isset($_POST['add_trademark'])) {
            ...
            $sql = "UPDATE noi_ve_khoa SET name = '$name', note = '$note', position = '$position' $add WHERE id = $id";
            $result = mysqli_query($conn_vn, $sql);
            if ($result) {
                echo '<script type="text/javascript">alert(\'Bạn đã sửa được một Nói về khoa.\')</script>';
            } else {
    ...
    $info = $action->getDetail('noi_ve_khoa', 'id', $_GET['id']);
?>
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP"><a href="index.php?page=noi-ve-khoa&khoa_id=<?= $info['khoa_id'] ?>">Quay lại</a><br /><br /></p>     
