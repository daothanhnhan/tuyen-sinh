...
?>
<form action="" method="post" accept-charset="utf-8" id="addNewsCat">
    
    <input type="hidden" name="action" value="addNewsCat">
    <input type="hidden" name="khoa_id" value="<?= $_GET['khoa_id'] ?>">
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="text" class="txtNCP1" id="title" onchange="ChangeToSlug()" value="<?= $row['newscat_name'];?>" name="newscat_name"/>
            <p class="titleRightNCP">Mô tả</p>
            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor1" name="newscat_des" ><?= $row['newscat_des'];?></textarea></p>
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <label class="selectCate">
                <input type="checkbox" value="1" name="dai_hoc" >
                Đại học
            </label>
            <label class="selectCate">
                <input type="checkbox" value="1" name="thac_si" >
                Thạc sĩ
            </label>
            <label class="selectCate">
                <input type="checkbox" value="1" name="tien_si" >
                Tiến sĩ
            </label>
            <label class="selectCate">
                <input type="checkbox" value="1" name="tin_tuc" >
                Tin tức
            </label>
            <label class="selectCate">
                <input type="checkbox" value="1" name="su_kien" >
                Sự kiện
            </label>
            <label class="selectCate">
                <input type="checkbox" value="1" name="gallery" >
                Gallery
            </label>
        </div>
    </div><!--end rowNodeContentPage-->
