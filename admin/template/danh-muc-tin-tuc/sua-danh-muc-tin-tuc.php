...
<?php
    ...
    $list = $action->getList('newscat','khoa_id',$_GET['khoa_id'],'newscat_id','desc','','','');
                            ...
                            <?php 
                                ...
                                ?>
                                    <div role="tabpanel" class="tab-pane <?= $key == 0 ? 'active' : ''?>" id="<?= $lang['languages_code']?>">
                                        ...
                                        <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor1<?= $lang['languages_code']?>" name="lang[<?= $lang['languages_code']?>][lang_newscat_des]" ><?= $rowDetailLang['lang_newscat_des'];?></textarea></p>

                                        <p class="titleRightNCP">Thông tin</p> 
                                        <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor1<?= $lang['languages_code']?>" name="lang[<?= $lang['languages_code']?>][lang_newscat_sub_info1]" ><?= $rowDetailLang['lang_newscat_sub_info1'];?></textarea></p>
...
<form action="" method="post" accept-charset="utf-8" id="updateNewsCat">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor1" name="newscat_des" ><?= $row_showMain['lang_newscat_des'];?></textarea></p>
            <p class="titleRightNCP">Thông tin</p>
            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor1" name="newscat_sub_info1" ><?= $row['newscat_sub_info1'];?></textarea></p>
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            <div>
                ...
                <label class="selectCate">
                    <input type="checkbox" value="1" name="dai_hoc" <?= $row['dai_hoc'] == 1 ? 'checked' : '' ?>>Đại học
                </label>
                <label class="selectCate">
                    <input type="checkbox" value="1" name="thac_si" <?= $row['thac_si'] == 1 ? 'checked' : '' ?>>Thạc sĩ
                </label>
                <label class="selectCate">
                    <input type="checkbox" value="1" name="tien_si" <?= $row['tien_si'] == 1 ? 'checked' : '' ?>>Tiến sĩ
                </label>
                <label class="selectCate">
                    <input type="checkbox" value="1" name="tin_tuc" <?= $row['tin_tuc'] == 1 ? 'checked' : '' ?>>Tin tức
                </label>
                <label class="selectCate">
                    <input type="checkbox" value="1" name="su_kien" <?= $row['su_kien'] == 1 ? 'checked' : '' ?>>Sự kiện
                </label>
                <label class="selectCate">
                    <input type="checkbox" value="1" name="gallery" <?= $row['gallery'] == 1 ? 'checked' : '' ?>>Gallery
                </label>
            </div>
