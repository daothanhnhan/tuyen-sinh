    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage" <?php echo ($_SESSION['admin_role']==2)?'style="display: none;"':'';?> >
            <div>
                ...
                <label class="selectCate">
                    <input type="checkbox" value="1" name="de_tai_du_an" <?= $row['de_tai_du_an'] == 1 ? 'checked' : '' ?>>Đề tài / dự án nghiên cứu
                </label>
                <label class="selectCate">
                    <input type="checkbox" value="1" name="cong_bo_khoa_hoc" <?= $row['cong_bo_khoa_hoc'] == 1 ? 'checked' : '' ?>>Công bố khoa học
                </label>
                <label class="selectCate">
                    <input type="checkbox" value="1" name="co_so_vat_chat" <?= $row['co_so_vat_chat'] == 1 ? 'checked' : '' ?>>Cơ sở vật chất
                </label>
            </div>
