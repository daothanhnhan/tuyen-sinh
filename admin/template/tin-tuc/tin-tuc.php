<?php
    if (isset($_GET['search']) && $_GET['search'] != '') {
       ...
       $rows = $action->getList('news','khoa_id',$_GET['khoa_id'],'news_id','desc',$trang,20,'tin-tuc');
    }
?>
    ...
    <table class="table table-hover">
        ...
        <tbody>
            <?php 
                ...
                ?>
                    <tr>
                        <td><a href="index.php?page=sua-tin-tuc&id=<?= $row['news_id']; ?>&khoa_id=<?= $_GET['khoa_id'] ?>" title=""><?= $row['news_name']; ?></a></td>
                        <td>
