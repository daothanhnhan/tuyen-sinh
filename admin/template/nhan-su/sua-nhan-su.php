<?php 
	...
	function nhan_su ($id) {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "UPDATE nhan_su SET name = '$name', position = '$position' $add WHERE id = $id";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã sửa được một nhân sự.\')</script>';
			} else {
	...
	$info = $action->getDetail('nhan_su', 'id', $_GET['id']);
?>
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP"><a href="index.php?page=nhan-su&khoa_id=<?= $info['khoa_id'] ?>">Quay lại</a><br /><br /></p>     
