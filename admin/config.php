...
<form action="" method="post" enctype="multipart/form-data" id="updateConfig">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            <div id="wrapper">
                ...
                <div id="image-holder">
                <?php 
                    if ($rowConfig['banner3'] != '') {
                    ?>
                        <img src="../images/<?= $rowConfig['banner3']?>" class="img-responsive" alt="Image">
                        <input type="hidden" name="banner3" value="<?= $rowConfig['banner3']?>">
                    <?php
                    }
                ?>                
                </div>
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="date" class="txtNCP1" value="<?php echo $row_showMain['lang_content_home9']?>" name="content_home9"/>
