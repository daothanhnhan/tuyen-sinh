<?php 
    $khoa = $action->getList('khoa', '', '', 'id', 'asc', '', '', '');
?>
<div class="fixedLeft">
    <div class="contentFL" style="overflow-y: scroll;height: 85%;">
        <ul class="listMenuFL">
            ...
            <!-- tab bài viết -->
           <li><a href="index.php?page=bai-viet&khoa_id=0" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'bai-viet1' || $_GET["page"] == 'sua-bai-viet1' || $_GET["page"] == 'them-bai-viet1') {
                       echo 'sltMenu';
                   } ?>"><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Trang Page</a></li>

            <!-- tab danh mục tin tức -->
            <li><a href="index.php?page=danh-muc-tin-tuc&khoa_id=0" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'danh-muc-tin-tuc1' || $_GET["page"] == 'sua-danh-muc-tin-tuc1' || $_GET["page"] == 'them-danh-muc-tin-tuc1') {
                       echo 'sltMenu';
                   } ?>"><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Danh
                    mục bài Post</a></li>

            <!-- tab tin tức -->
            <li><a href="index.php?page=tin-tuc&khoa_id=0" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'tin-tuc1' || $_GET["page"] == 'them-tin-tuc1' || $_GET["page"] == 'sua-tin-tuc1') {
                       echo 'sltMenu';
           ...
           <!-- <li><a href="index.php?page=danh-muc-dich-vu" title=""
            ...
            <!-- tab menu -->
            <li><a href="index.php?page=trinh-don&khoa_id=0" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'trinh-don1' || $_GET["page"] == 'them-trinh-don1' || $_GET["page"] == 'sua-trinh-don1') {
                       echo 'sltMenu';
            ...
            <li><a href="index.php?page=khoa" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Khoa</a>
            </li>

            <li style=""><a href="index.php?page=doi-tac&khoa_id=0" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đối tác</a>
            </li>
            <!-- <li><a href="index.php?page=gallery" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Video Gallery</a>
            </li> -->

            <li><a href="index.php?page=#" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>LDP Khoa</a>
            </li>
            <?php foreach ($khoa as $item) { ?>
                <li style="margin-left: 20px;"><a href="index.php?page=#" title="" style="background: #8d8de9;" 
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/><?= $item['name'] ?></a>
                </li>
                
                <li style="margin-left: 20px;"><a href="index.php?page=bai-viet&khoa_id=<?= $item['id'] ?>" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Trang Page</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=danh-muc-tin-tuc&khoa_id=<?= $item['id'] ?>" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Danh mục bài Post</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=tin-tuc&khoa_id=<?= $item['id'] ?>" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Danh sách bài Post</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=trinh-don&khoa_id=<?= $item['id'] ?>" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Menu</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=lien-he&khoa_id=<?= $item['id'] ?>" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Liên hệ</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=slide&khoa_id=<?= $item['id'] ?>" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Slide</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=noi-ve-khoa&khoa_id=<?= $item['id'] ?>" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>SV nói về khoa</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=doi-tac&khoa_id=<?= $item['id'] ?>" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đối tác</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=nhan-su&khoa_id=<?= $item['id'] ?>" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Nhân sự</a>
                </li>
            <?php } ?>
            <li><a href="index.php?page=#" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>LDP Hợp tác quốc tế</a>
            </li>
                <li style="margin-left: 20px;"><a href="index.php?page=bai-viet&khoa_id=1" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Trang Page</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=danh-muc-tin-tuc&khoa_id=1" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Danh mục bài Post</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=tin-tuc&khoa_id=1" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Danh sách bài Post</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=trinh-don&khoa_id=1" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Menu</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=slide&khoa_id=1" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Slide</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=noi-ve-khoa&khoa_id=1" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>SV nói về khoa</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=doi-tac&khoa_id=1" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đối tác</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=nhan-su&khoa_id=1" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Nhân sự</a>
                </li>
            <li><a href="index.php?page=#" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>LDP Sinh viên</a>
            </li>
                <li style="margin-left: 20px;"><a href="index.php?page=bai-viet&khoa_id=2" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Trang Page</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=danh-muc-tin-tuc&khoa_id=2" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Danh mục bài Post</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=tin-tuc&khoa_id=2" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Danh sách bài Post</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=trinh-don&khoa_id=2" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Menu</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=slide&khoa_id=2" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Slide</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=noi-ve-khoa&khoa_id=2" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>SV nói về khoa</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=doi-tac&khoa_id=2" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đối tác</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=nhan-su&khoa_id=2" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Nhân sự</a>
                </li>
                

            <li><a href="index.php?page=#" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>LDP Nghên cứu</a>
            </li>
                <li style="margin-left: 20px;"><a href="index.php?page=bai-viet&khoa_id=3" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Trang Page</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=danh-muc-tin-tuc&khoa_id=3" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Danh mục bài Post</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=tin-tuc&khoa_id=3" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Danh sách bài Post</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=trinh-don&khoa_id=3" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Menu</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=slide&khoa_id=3" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Slide</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=noi-ve-khoa&khoa_id=3" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>SV nói về khoa</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=doi-tac&khoa_id=3" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đối tác</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=nhan-su&khoa_id=3" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Nhân sự</a>
                </li>
                <li style="margin-left: 20px;"><a href="index.php?page=guong-mat&khoa_id=3" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Gương mặt</a>
                </li>
    ...
    <div class="rightFixedTop">
        ...
        if (isset($_GET["page"])) {
            switch ($_GET["page"]) {
                ...
                case "trinh-don":
                    echo "<a href='index.php?page=them-trinh-don&khoa_id=".$_GET['khoa_id']."' class='btn btnAddTop'>Thêm Mới</a>";
                    break;
                ...
                case "sua-bai-viet":
                    ...
                    echo "<a class='btnTop btnAddTop' href='index.php?page=them-bai-viet&khoa_id=".$_GET['khoa_id']."'>Thêm mới</a>";
                    break;

                case "bai-viet":
                    echo "<a href='index.php?page=them-bai-viet&khoa_id=".$_GET['khoa_id']."' class='btnTop btnAddTop'>Thêm Mới</a>";
                    break;
                ...
                case "sua-danh-muc-tin-tuc":
                    ...
                    echo "<a class='btnTop btnAddTop' href='index.php?page=them-danh-muc-tin-tuc&khoa_id=".$_GET['khoa_id']."'>Thêm mới</a>";
                    break;

                case "danh-muc-tin-tuc":
                    echo "<a href='index.php?page=them-danh-muc-tin-tuc&khoa_id=".$_GET['khoa_id']."' class='btnTop btnAddTop'>Thêm Mới</a>";
                    break;
                ...
                /*-------------- Tin tức ------------*/
                case "tin-tuc":
                    echo "<a href='index.php?page=them-tin-tuc&khoa_id=".$_GET['khoa_id']."' class='btnTop btnAddTop'>Thêm Mới</a>";
                    break;

                case "them-tin-tuc":
                    echo "<a class='btnTop btnAddTop' href='index.php?page=tin-tuc'>Quay lại</a>";
                    echo "<a class='btnTop btnAddTop' href='index.php?page=them-tin-tuc&khoa_id=".$_GET['khoa_id']."'>Thêm mới</a>";
                    break;
