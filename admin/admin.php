        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    ////////////// khoa ///////////////////
                    case "khoa":
                        include_once("template/khoa/khoa.php");
                        break;
                    case "them-khoa":
                        include_once("template/khoa/them-khoa.php");
                        break;
                    case "sua-khoa":
                        include_once("template/khoa/sua-khoa.php");
                        break;
                    case "xoa-khoa":
                        include_once("template/khoa/sua-khoa.php");
                        break;
                    ...
                    //////////// noi ve khoa //////////////
                    case "noi-ve-khoa":
                        include_once("template/noi-ve-khoa/noi-ve-khoa.php");
                        break;
                    case "them-noi-ve-khoa":
                        include_once("template/noi-ve-khoa/them-noi-ve-khoa.php");
                        break;
                    case "sua-noi-ve-khoa":
                        include_once("template/noi-ve-khoa/sua-noi-ve-khoa.php");
                        break;
                    case "xoa-noi-ve-khoa":
                        include_once("template/noi-ve-khoa/xoa-noi-ve-khoa.php");
                        break;
                    ///////////// doi tac /////////////////
                    case "doi-tac":
                        include_once("template/doi-tac/doi-tac.php");
                        break;
                    case "them-doi-tac":
                        include_once("template/doi-tac/them-doi-tac.php");
                        break;
                    case "sua-doi-tac":
                        include_once("template/doi-tac/sua-doi-tac.php");
                        break;
                    case "xoa-doi-tac":
                        include_once("template/doi-tac/xoa-doi-tac.php");
                        break;
                    ////////////// nhan su /////////////////
                    case "nhan-su":
                        include_once("template/nhan-su/nhan-su.php");
                        break;
                    case "them-nhan-su":
                        include_once("template/nhan-su/them-nhan-su.php");
                        break;
                    case "sua-nhan-su":
                        include_once("template/nhan-su/sua-nhan-su.php");
                        break;
                    case "xoa-nhan-su":
                        include_once("template/nhan-su/xoa-nhan-su.php");
                        break;
                    ////////////// guong mat //////////////
                    case "guong-mat":
                        include_once("template/guong-mat/guong-mat.php");
                        break;
                    case "them-guong-mat":
                        include_once("template/guong-mat/them-guong-mat.php");
                        break;
                    case "sua-guong-mat":
                        include_once("template/guong-mat/sua-guong-mat.php");
                        break;
                    case "xoa-guong-mat":
                        include_once("template/guong-mat/xoa-guong-mat.php");
                        break;
                    ///////////// gallery /////////////////
                    case "gallery":
                        include_once("template/gallery/gallery.php");
                        break;
                    case "them-gallery":
                        include_once("template/gallery/them-gallery.php");
                        break;
                    case "sua-gallery":
                        include_once("template/gallery/sua-gallery.php");
                        break;
                    case "xoa-gallery":
                        include_once("template/gallery/xoa-gallery.php");
                        break;
                    ///////////// Default /////////////////
                    default:
