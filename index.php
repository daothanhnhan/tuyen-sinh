...
if (isset($_GET['page'])) {
  ...
  if ($urlAnalytic == 'newscat_languages') {
    $khoa_id = $action->getDetail('newscat', 'friendly_url', $_GET['page'])['khoa_id'];
  }
  if ($urlAnalytic == 'news_languages') {
    $khoa_id = $action->getDetail('news', 'friendly_url', $_GET['page'])['khoa_id'];
  }
  if ($urlAnalytic == 'page_language') {
    $khoa_id = $action->getDetail('page', 'friendly_url', $_GET['page'])['khoa_id'];
  }
  if ($_GET['page'] == 'khoa') {
    $khoa_id = $_GET['trang'];
  }
  if ($_GET['page'] == 'nhan-su') {
    $khoa_id = $_GET['trang'];
  }
  if ($_GET['page'] == 'lien-he') {
    $khoa_id = $_GET['trang'];
  }
  if ($_GET['page'] == 'hop-tac-quoc-te') {
    $khoa_id = 1;
  }
  if ($_GET['page'] == 'sinh-vien') {
    $khoa_id = 2;
  }
  if ($_GET['page'] == 'nghien-cuu') {
    $khoa_id = 3;
  }
}
?>
...
<div class="gb-content">
    ...
    if (isset($_GET['page'])){
        ...
        switch ($urlAnalytic) {
            ...
            case 'khoa':
                include_once dirname(__FILE__) . DIR_THEMES."khoa.php";break;

            case 'nhan-su':
                include_once dirname(__FILE__) . DIR_THEMES."nhan-su.php";break;

            case 'nghien-cuu':
                include_once dirname(__FILE__) . DIR_THEMES."nghien-cuu.php";break;

            case 'sinh-vien':
                include_once dirname(__FILE__) . DIR_THEMES."sinh-vien.php";break;

            case 'hop-tac-quoc-te':
                include_once dirname(__FILE__) . DIR_THEMES."hop-tac-quoc-te.php";break;
