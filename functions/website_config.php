	...
	if (isset($urlAnalytic) && $urlAnalytic != '') {        
		switch ($urlAnalytic) {
			...
			case 'newscat_languages':
            	...
            	if (isset($_GET['slug']) && $_GET['slug'] != '') {
                    $slug = $_GET['slug'];
                    $rowLang = $action_NewsMeta->getNewsCatLangDetail_byUrl_1($slug,$lang);
                    $title = $rowLang['title_seo'];
                    $meta_des = $rowLang['des_seo'];
                    $meta_key = $rowLang['keyword'];
                }
            ...
            case 'news_languages':
            	...
            	if (isset($_GET['slug']) && $_GET['slug'] != '') {
                    $slug = $_GET['slug'];
                    $rowLang = $action_NewsMeta->getNewsLangDetail_byUrl_1($slug,$lang);
                    $title = $rowLang['title_seo'];
                    $meta_des = $rowLang['des_seo'];
                    $meta_key = $rowLang['keyword'];
                }
            ...
            case 'page_language':
            	...
            	if (isset($_GET['slug']) && $_GET['slug'] != '') {
                    ...
                    $rowLang = $action_PageMeta->getPageLangDetail_byUrl_1($slug,$lang);
                    $title = $rowLang['title_seo'];                    
                    $meta_des = $rowLang['des_seo'];
                    $meta_key = $rowLang['keyword'];
                }
