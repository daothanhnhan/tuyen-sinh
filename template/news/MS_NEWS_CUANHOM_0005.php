<?php 
	...
	$chuong_trinh_dao_tao = $action->getDetail_New('page_languages', array('page_id', 'languages_code'), array(52, &$lang), 'is');
?>
<style>

</style>
<div class="container chuong-trinh-dao-tao">
	<p class="title"><a><?= $chuong_trinh_dao_tao['lang_page_name'] ?></a></p>
	<div class="svg">
		<img src="/images/title.svg" alt="svg">
	</div>
	<p class="des"><?= $chuong_trinh_dao_tao['lang_page_des'] ?></p>
				...
				<div class="sub">
					<p class="title">
						<a href="/<?= $dai_hoc['friendly_url'] ?>">
							<span><?= $lang=='vn' ? 'Đại học' : 'University' ?></span> <?= $dai_hoc_lang['lang_newscat_sub_info1'] ?>
						</a>
					</p>
				...
				<div class="sub">
					<p class="title">
						<a href="/<?= $thac_si['friendly_url'] ?>">
							<span><?= $lang=='vn' ? 'Thạc sĩ' : 'Master' ?></span> <?= $thac_si_lang['lang_newscat_sub_info1'] ?>
						</a>
					</p>
				...
				<div class="sub">
					<p class="title">
						<a href="/<?= $tien_si['friendly_url'] ?>">
							<span><?= $lang=='vn' ? 'Tiến sĩ' : 'Doctor' ?></span> <?= $tien_si_lang['lang_newscat_sub_info1'] ?>
						</a>
					</p>
