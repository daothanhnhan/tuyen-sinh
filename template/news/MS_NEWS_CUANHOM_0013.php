<?php 
	$cuu_sinh_vien = $action->getList('news', 'newscat_id', '96', 'news_id', 'desc', '', '8', '');
	$cuu_sinh_vien_cat = $action->getDetail_New('newscat_languages', array('newscat_id', 'languages_code'), array(96, $lang), 'is');
?>
<style>
...
<div class="container margin-top-1">
	<div class="title-modul">
		<p class="title"><a><?= $cuu_sinh_vien_cat['lang_newscat_name'] ?></a></p>
		<div class="svg">
